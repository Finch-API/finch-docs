...
---------|----------|---------
 ...
 `payroll_provider` | false | An optional parameter that allows users to bypass the provider selection screen. Compatible payrolls are: `rippling`, `zenefits`, `gusto`, `justworks`, `bamboo_hr`, and `quickbooks`.
